 ...
 * on 2017-11-08 at 19:34:42 UTC 
 * Modify at your own risk.
 */

package com.appspot.tweet_webtoken_api.usuarios_api;
...
public class UsuariosApi extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class User {
     ...
     *
     * @param content the {@link com.appspot.tweet_webtoken_api.usuarios_api.model.MessagesUserUpdate}
     * @return the request
     */
    public Update update(com.appspot.tweet_webtoken_api.usuarios_api.model.MessagesUserUpdate content) throws java.io.IOException {
      Update result = new Update(content);
      initialize(result);
      return result;
    }

    public class Update extends UsuariosApiRequest<com.appspot.tweet_webtoken_api.usuarios_api.model.MessagesCodeMessage> {
       ...
       * @since 1.13
       */
      protected Update(com.appspot.tweet_webtoken_api.usuarios_api.model.MessagesUserUpdate content) {
        super(UsuariosApi.this, "POST", REST_PATH, content, com.appspot.tweet_webtoken_api.usuarios_api.model.MessagesCodeMessage.class);
      }
  ...
  public class Users {
     ...
     *
     * @param content the {@link com.appspot.tweet_webtoken_api.usuarios_api.model.MessagesTokenKey}
     * @return the request
     */
    public Delete delete(com.appspot.tweet_webtoken_api.usuarios_api.model.MessagesTokenKey content) throws java.io.IOException {
      Delete result = new Delete(content);
      initialize(result);
      return result;
    }

    public class Delete extends UsuariosApiRequest<com.appspot.tweet_webtoken_api.usuarios_api.model.MessagesCodeMessage> {
       ...
       * @since 1.13
       */
      protected Delete(com.appspot.tweet_webtoken_api.usuarios_api.model.MessagesTokenKey content) {
        super(UsuariosApi.this, "POST", REST_PATH, content, com.appspot.tweet_webtoken_api.usuarios_api.model.MessagesCodeMessage.class);
      }
     ...
     * @return the request
     */
    public Get get(com.appspot.tweet_webtoken_api.usuarios_api.model.MessagesTokenKey content) throws java.io.IOException {
      Get result = new Get(content);
      initialize(result);
      return result;
    }

    public class Get extends UsuariosApiRequest<com.appspot.tweet_webtoken_api.usuarios_api.model.MessagesUserList> {
       ...
       * @since 1.13
       */
      protected Get(com.appspot.tweet_webtoken_api.usuarios_api.model.MessagesTokenKey content) {
        super(UsuariosApi.this, "POST", REST_PATH, content, com.appspot.tweet_webtoken_api.usuarios_api.model.MessagesUserList.class);
      }
     ...
     *
     * @param content the {@link com.appspot.tweet_webtoken_api.usuarios_api.model.MessagesUserInput}
     * @return the request
     */
    public Insert insert(com.appspot.tweet_webtoken_api.usuarios_api.model.MessagesUserInput content) throws java.io.IOException {
      Insert result = new Insert(content);
      initialize(result);
      return result;
    }

    public class Insert extends UsuariosApiRequest<com.appspot.tweet_webtoken_api.usuarios_api.model.MessagesCodeMessage> {
       ...
       * @since 1.13
       */
      protected Insert(com.appspot.tweet_webtoken_api.usuarios_api.model.MessagesUserInput content) {
        super(UsuariosApi.this, "POST", REST_PATH, content, com.appspot.tweet_webtoken_api.usuarios_api.model.MessagesCodeMessage.class);
      }
     ...
     *
     * @param content the {@link com.appspot.tweet_webtoken_api.usuarios_api.model.MessagesToken}
     * @return the request
     */
    public List list(com.appspot.tweet_webtoken_api.usuarios_api.model.MessagesToken content) throws java.io.IOException {
      List result = new List(content);
      initialize(result);
      return result;
    }

    public class List extends UsuariosApiRequest<com.appspot.tweet_webtoken_api.usuarios_api.model.MessagesUserList> {
       ...
       * @since 1.13
       */
      protected List(com.appspot.tweet_webtoken_api.usuarios_api.model.MessagesToken content) {
        super(UsuariosApi.this, "POST", REST_PATH, content, com.appspot.tweet_webtoken_api.usuarios_api.model.MessagesUserList.class);
      }
     ...
     *
     * @param content the {@link com.appspot.tweet_webtoken_api.usuarios_api.model.MessagesEmailPasswordMessage}
     * @return the request
     */
    public Login login(com.appspot.tweet_webtoken_api.usuarios_api.model.MessagesEmailPasswordMessage content) throws java.io.IOException {
      Login result = new Login(content);
      initialize(result);
      return result;
    }

    public class Login extends UsuariosApiRequest<com.appspot.tweet_webtoken_api.usuarios_api.model.MessagesTokenMessage> {
       ...
       * @since 1.13
       */
      protected Login(com.appspot.tweet_webtoken_api.usuarios_api.model.MessagesEmailPasswordMessage content) {
        super(UsuariosApi.this, "POST", REST_PATH, content, com.appspot.tweet_webtoken_api.usuarios_api.model.MessagesTokenMessage.class);
      }
