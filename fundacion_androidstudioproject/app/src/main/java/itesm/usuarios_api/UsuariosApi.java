...
public class UsuariosApi extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class User {
     ...
     *
     * @param content the {@link itesm.usuarios_api.model.model.MessagesUserUpdate}
     * @return the request
     */
    public Update update(itesm.usuarios_api.model.MessagesUserUpdate content) throws java.io.IOException {
      Update result = new Update(content);
      initialize(result);
      return result;
    }

    public class Update extends UsuariosApiRequest<itesm.usuarios_api.model.MessagesCodeMessage> {
       ...
       *
       * @param content the {@link itesm.usuarios_api.model.MessagesUserUpdate}
       * @since 1.13
       */
      protected Update(itesm.usuarios_api.model.MessagesUserUpdate content) {
        super(UsuariosApi.this, "POST", REST_PATH, content, itesm.usuarios_api.model.MessagesCodeMessage.class);
      }
  ...
  public class Users {
     ...
     *
     * @param content the {@link itesm.usuarios_api.model.MessagesTokenKey}
     * @return the request
     */
    public Delete delete(itesm.usuarios_api.model.MessagesTokenKey content) throws java.io.IOException {
      Delete result = new Delete(content);
      initialize(result);
      return result;
    }

    public class Delete extends UsuariosApiRequest<itesm.usuarios_api.model.MessagesCodeMessage> {
       ...
       * @since 1.13
       */
      protected Delete(itesm.usuarios_api.model.MessagesTokenKey content) {
        super(UsuariosApi.this, "POST", REST_PATH, content, itesm.usuarios_api.model.MessagesCodeMessage.class);
      }
     ...
     * @return the request
     */
    public Get get(itesm.usuarios_api.model.MessagesTokenKey content) throws java.io.IOException {
      Get result = new Get(content);
      initialize(result);
      return result;
    }

    public class Get extends UsuariosApiRequest<itesm.usuarios_api.model.MessagesUserList> {
       ...
       * @since 1.13
       */
      protected Get(itesm.usuarios_api.model.MessagesTokenKey content) {
        super(UsuariosApi.this, "POST", REST_PATH, content, itesm.usuarios_api.model.MessagesUserList.class);
      }
     ...
     *
     * @param content the {@link itesm.usuarios_api.model.MessagesUserInput}
     * @return the request
     */
    public Insert insert(itesm.usuarios_api.model.MessagesUserInput content) throws java.io.IOException {
      Insert result = new Insert(content);
      initialize(result);
      return result;
    }

    public class Insert extends UsuariosApiRequest<itesm.usuarios_api.model.MessagesCodeMessage> {
       ...
       * @since 1.13
       */
      protected Insert(itesm.usuarios_api.model.MessagesUserInput content) {
        super(UsuariosApi.this, "POST", REST_PATH, content, itesm.usuarios_api.model.MessagesCodeMessage.class);
      }
     ...
     *
     * @param content the {@link itesm.usuarios_api.model.MessagesToken}
     * @return the request
     */
    public List list(itesm.usuarios_api.model.MessagesToken content) throws java.io.IOException {
      List result = new List(content);
      initialize(result);
      return result;
    }

    public class List extends UsuariosApiRequest<itesm.usuarios_api.model.MessagesUserList> {
       ...
       * @since 1.13
       */
      protected List(itesm.usuarios_api.model.MessagesToken content) {
        super(UsuariosApi.this, "POST", REST_PATH, content, itesm.usuarios_api.model.MessagesUserList.class);
      }
     ...
     *
     * @param content the {@link itesm.usuarios_api.model.MessagesEmailPasswordMessage}
     * @return the request
     */
    public Login login(itesm.usuarios_api.model.MessagesEmailPasswordMessage content) throws java.io.IOException {
      Login result = new Login(content);
      initialize(result);
      return result;
    }

    public class Login extends UsuariosApiRequest<itesm.usuarios_api.model.MessagesTokenMessage> {
       ...
       * @since 1.13
       */
      protected Login(itesm.usuarios_api.model.MessagesEmailPasswordMessage content) {
        super(UsuariosApi.this, "POST", REST_PATH, content, itesm.usuarios_api.model.MessagesTokenMessage.class);
      }
